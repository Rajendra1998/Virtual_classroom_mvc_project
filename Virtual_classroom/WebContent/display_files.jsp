...
<title> FACULTY | VIEW_FILES </title>
	...
	<center>
     <div class="panel">
            ...
            <table class="bordered_table" align=center border="3" width="1000px">
               <thead>
                  <tr align="center"><th>File Name</th><th>File Size</th><th colspan=2>Action</th></tr>
               </thead>
               <tbody>
                  ...
                  <tr>
                     ...
                     <td align="center"><span id="fileDownload"><a id="downloadLink" class="hyperLink" href="download?fileName=<%=uploadDetails.get(i).getFileName() %>">Download</a></span></td>
           			 <td align="center"><span id="fileDelete"><a id="deleteLink" class="hyperLink" href="delete?fileName=<%=uploadDetails.get(i).getFileName() %>">Delete</a></span></td>
                  </tr>
                  <% }
                   } else { %>
                  <tr>

                     <td colspan="4" align="center"><span id="noFiles">No Files Uploaded.....!</span></td>
         ...
         <nav>
			<ul>
				...
				<li class="add"><a href="file_upload.jsp"><br><i class="fa fa-user-plus" aria-hidden="true"></i><br>Upload File</a></li>
			</ul>
		</nav>
	</div>
